...
import { cx, focusInput, focusRing, hasErrorInput } from "@/registry/default/utils/utils"
    ...
    return (
      <div className={cx("relative w-full", className)}>
        ...
        {isPassword && (
          ...
          >
            <button
              aria-label="Change password visibility"              className={cx(
                // base
